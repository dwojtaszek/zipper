...
public class ArchiveTestSuiteContractTests
{
    ...
    [Fact]
    public void Catalogue_ContainsExactlyTheFrozenSixtyFiveCaseKeys()
    {
        ...
        // a case dropped from the catalogue or unlisted from every suite fails here.
        Assert.Equal(65, AllKeys().Count);
    }
}
