...
internal static class HelpTextGenerator
{
    public static void Show()
    {
        ...
        Console.Error.WriteLine();
        Console.Error.WriteLine("Production Manifest Comparison Options:");
        Console.Error.WriteLine("  --compare-production-manifests <paths> Compare two or more production manifests (bypasses file generation)");
        Console.Error.WriteLine("  --comparison-mode <replacement|supplemental|reproduction> Comparison ruleset mode (required with --compare-production-manifests)");
        Console.Error.WriteLine("  --comparison-output <path> Output path for the comparison JSON report (required with --compare-production-manifests)");
        Console.Error.WriteLine();
        Console.Error.WriteLine("Bates Numbering:");
        Console.Error.WriteLine("  --bates-prefix <string>  Bates Number prefix, max 200 UTF-8 bytes per list element (e.g., CLIENT001)");
