...
| `--bates-prefix` | none | string (or comma-separated list), maximum 200 UTF-8 bytes per element | Bates Number prefix |
...
| `--production-id` | auto | string, maximum 250 UTF-8 bytes per generated element (after rolling derivation) | Production ID for the Production Set |
