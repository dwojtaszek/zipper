...
- **REQ-186**: In Production Set mode, `--with-collection-metadata` is silently ignored (no columns added, no error). Production Set DAT uses its own fixed column schema (REQ-148, FR-023) that does not include Collection Metadata columns.
