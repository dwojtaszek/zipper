...
- **REQ-211**: Archive Test Fixture generation shall be deterministic under `--seed`, which defaults to 42. The same Seed and case definition shall always produce byte-identical fixture Archives and Expectation Files.
